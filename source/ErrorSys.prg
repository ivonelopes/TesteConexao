...
FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.
   ...
   "Harbour Project"
   Copyright 1999-2015, http://harbour-project.org/
...
*-----------------------------------------------------------------------------*
   ...
   IF _lShowError
      ...
      // Envia Email do Arquivo "Errorlog.htm e appaga o arquivo Errorlog.htm
//      email()    // tirei provis[óriamente dia 14/03/2020
